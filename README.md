...
![TicketMan Logo](https://buffal0x.org/img/ticketman_wallpaper.png)

---

## 🚀 Features

- 📋 Create, edit and delete events - Upload.excel files
- ✅ Manage guest lists and check-in guests
- 🔒 Secure login and registration system
- 🎨 Modern responsive UI with Tailwind CSS
- 🧠 Built with PHP, MySQL & JavaScript
- 🛡️ Protection against SQLi, XSS, CSRF
